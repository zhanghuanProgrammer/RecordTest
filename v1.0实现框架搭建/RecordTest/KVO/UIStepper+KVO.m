...
#import "UIStepper+KVO.h"
#import "RecordTestHeader.h"

@implementation UIStepper (KVO)
                ...
                if (actions.count > 0) {
                    ...
                    if (target && [target respondsToSelector:sel]) {
                        ...
                        [target aspect_hookSelector:sel withOptions:AspectPositionAfter usingBlock:^{
                            ...
                            [RTOperationQueue addOperation:view type:(RTOperationQueueTypeEvent) parameters:@[NSStringFromSelector(sel),@(self.value)] repeat:NO];
                        } after:nil error:nil];
                    }
                }
            }
