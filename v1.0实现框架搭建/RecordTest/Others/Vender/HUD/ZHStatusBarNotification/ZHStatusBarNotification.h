...
#import "ZHStatusBarStyle.h"
#import "ZHStatusBarView.h"

/**
 *  A block that is used to define the appearance of a notification.
 *  A ZHStatusBarStyle instance defines the notification appeareance.
 *
 *  @param style The current default ZHStatusBarStyle instance.
 *
 *  @return The modified ZHStatusBarStyle instance.
 */
typedef ZHStatusBarStyle*(^JDPrepareStyleBlock)(ZHStatusBarStyle *style);
 ...
 *  given class methods.
 */
@interface ZHStatusBarNotification : NSObject
 ...
 */
+ (ZHStatusBarView*)showWithStatus:(NSString *)status;
 ...
 *
 *  @param status The message to display
 *  @param styleName The name of the style. You can use any ZHStatusBarStyle constant
 ...
 *
 *  @param prepareBlock A block, which has a ZHStatusBarStyle instance as
